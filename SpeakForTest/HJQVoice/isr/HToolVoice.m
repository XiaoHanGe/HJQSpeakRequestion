...
- (void)startForVoice:(UIView*)view
{
    ...
    CGFloat posY = 60;
    _popUpView = [[PopupView alloc] initWithFrame:CGRectMake(100, posY, 0, 0) withParentView:view];
    ...
    _textViewString = [[UITextView alloc]initWithFrame:CGRectMake(10, 200, 200, 40)];
